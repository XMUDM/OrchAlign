...
from src.dataloaders.datasets.promo_enhan_inter import PromoterEnhancerDataset, ExperInteractDataset,ExperAliDataset
...
class CAGEPredictors(HG38):
    ...
    def __init__(self, exper_name_cage, exper_name_dnase, exper_name_h3k27ac, exper_name_h3k4me3,
                 cell_type, organism='human', genome='hg38', assay_type='HiC', qval=0.1,
...
class PromoEnhanInter(CAGEPredictors):
    ...
    def init_datasets(self):
        ...
        if self.dataset_name == 'EPInformer':
            ...
            # 执行 distance_threshold=100000 ,100k
            ...
            #     cell_type=self.cell_type,
            #     distance_threshold=self.distance_threshold,
            #     hic_threshold=self.hic_threshold, #null
            #     n_enhancers=self.n_enhancers, # 60
            #     seq_range=self.seq_range, #2000
            #     zero_dist=self.zero_dist,
            #     zero_activity=self.zero_activity,
            #     zero_hic=self.zero_hic,
            #     omit_enhancers=self.omit_enhancers,
        ...
        print('dataset_test#,',self.dataset_test[0])
